...
export const LEARNING_LANGUAGES: LanguageOption[] = [
  { code: 'en-US', nativeName: 'English', localizedNames: { en: 'English (US)', fr: 'Anglais (É.-U.)' } },
  { code: 'en-GB', nativeName: 'English (UK)', localizedNames: { en: 'English (UK)', fr: 'Anglais (R.-U.)' } },
  { code: 'es-419', nativeName: 'Español (Latinoamérica)', localizedNames: { en: 'Spanish (Latin America)', fr: 'Espagnol (Amérique latine)' } },
  { code: 'es-ES', nativeName: 'Español (España)', localizedNames: { en: 'Spanish (Spain)', fr: 'Espagnol (Espagne)' } },
  { code: 'fr-FR', nativeName: 'Français', localizedNames: { en: 'French', fr: 'Français' } },
  { code: 'pt-BR', nativeName: 'Português (Brasil)', localizedNames: { en: 'Portuguese (Brazil)', fr: 'Portugais (Brésil)' } },
  { code: 'pt-PT', nativeName: 'Português (Portugal)', localizedNames: { en: 'Portuguese (Portugal)', fr: 'Portugais (Portugal)' } },
  ...
  { code: 'ro-RO', nativeName: 'Română', localizedNames: { en: 'Romanian (beta)', fr: 'Roumain (bêta)' } },
  { code: 'ca-ES', nativeName: 'Català', localizedNames: { en: 'Catalan (beta)', fr: 'Catalan (bêta)' } },
];

/** Region/script choice shown when the learning language is Chinese. */
export const SCRIPT_OPTIONS: LanguageOption[] = [
  { code: 'zh-CN', nativeName: '简体中文', localizedNames: { en: 'Simplified Chinese', fr: 'Chinois simplifié' } },
  { code: 'zh-TW', nativeName: '繁體中文', localizedNames: { en: 'Traditional Chinese', fr: 'Chinois traditionnel' } },
];
...
export const APP_LANGUAGES: LanguageOption[] = [
  ...
  { code: 'zh-Hans', nativeName: '简体中文', localizedNames: { en: 'Chinese (Simplified)', fr: 'Chinois (simplifié)' } },
  { code: 'zh-Hant', nativeName: '繁體中文', localizedNames: { en: 'Chinese (Traditional)', fr: 'Chinois (traditionnel)' } },
