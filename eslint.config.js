...
export default tseslint.config(
  {
    ignores: [
      ...
      // Gitignored scratch space for e2e scripts (.gitignore's `.cache/`) —
      // throwaway diagnostics dropped here are, by design, not meant to be
      // committed or held to lint's standards.
      'apps/client/e2e/.cache/**',
