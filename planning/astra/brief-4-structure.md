# Sotto deep bug audit, lane 4 of 4: navigation state, contract drift against CONTRACTS.md, test coverage gaps
...
You own areas J, K, L. Three other auditors own the rest in parallel; do not spend turns on their areas except where a trace from yours leads there.
