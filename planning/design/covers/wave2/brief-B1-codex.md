...
The eight books:
- ca-patufet: "En Patufet" (Patufet) by Traditional (Catalan folk tale), level A0, collections ['folk']. Premise: A tiny boy as small as a grain of rice goes on an adventure to help his parents.
- zh-chengyu-stories-hant: "三個成語故事" (Three Chinese Idiom Stories) by Traditional (ancient Chinese sources: Han Feizi, Zhan Guo Ce), level A0, collections ['idioms']. Premise: Three classic fables behind famous Chinese idioms, retold in very simple modern Mandarin.
- fr-cendrillon: "Cendrillon" (Cendrillon) by Charles Perrault, level A1, collections ['tales']. Premise: A kind girl is treated cruelly by her stepmother and stepsisters, until a fairy godmother changes everything for one magical night.
- es-monte-de-las-animas: "El monte de las ánimas" (El monte de las ánimas) by Gustavo Adolfo Bécquer, level A2, collections ['tales', 'folk']. Premise: On the night the dead are said to walk, a young man risks the legendary Mount of Souls to answer his cousin's dare.
- es-palma-tradiciones: "Tradiciones peruanas" (Peruvian Traditions) by Ricardo Palma, level B1, collections ['folk', 'classics']. Premise: Two of Ricardo Palma's famous retellings of colonial Lima: a strict rector who gets a surprise years after punishing a schoolboy, and a rich man's daughter whose forbidden love produces the most expensive shirt in Peru.
- fr-verne-tour-du-monde: "Le Tour du monde en quatre-vingts jours" (Around the World in Eighty Days) by Jules Verne, level B1, collections ['adventure', 'classics']. Premise: A rich, mysterious London gentleman bets his entire fortune that he can circle the globe in eighty days — and sets off that same evening with his brand-new French valet.
- es-becquer-maese-perez: "Maese Pérez el organista" (Master Pérez, the Organist) by Gustavo Adolfo Bécquer, level B2, collections ['tales', 'classics']. Premise: In Seville, a blind old organist insists on playing the Christmas Eve mass one last time, though it may cost him his life.
- fr-voltaire-candide: "Candide" (Candide) by Voltaire, level B2, collections ['classics']. Premise: A gentle young man raised on the idea that everything happens for the best is thrown out of his sheltered château for a stolen kiss, and the real world wastes no time proving his tutor wrong.
