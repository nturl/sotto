...
The eight books:
- es-fabulas-samaniego: "Tres fábulas de Samaniego" (Three Fables by Samaniego) by Félix María de Samaniego, level A0, collections ['fables']. Premise: Three animals and a young milkmaid learn practical lessons from their mistakes.
- es-lazarillo: "Lazarillo de Tormes" (Lazarillo of Tormes) by Anonymous, level A1, collections ['classics']. Premise: A poor boy learns to survive while guiding a clever blind man.
- fr-fables-la-fontaine: "Trois fables de La Fontaine" (Three Fables by La Fontaine) by Jean de La Fontaine, level A1, collections ['fables']. Premise: Three animals learn about vanity, preparation, and perseverance.
- en-london-build-a-fire: "To Build a Fire" (To Build a Fire) by Jack London, level B1, collections ['adventure', 'classics']. Premise: A man and his dog walk alone through the frozen Yukon, and the man must learn, too late, that the cold does not forgive small mistakes.
- fr-daudet-derniere-classe: "La Dernière Classe" (The Last Class) by Alphonse Daudet, level B1, collections ['classics']. Premise: A schoolboy who dreads his grammar lesson discovers, on arriving late, that it is the very last French class his village will ever have.
- pt-machado-cartomante: "A Cartomante" (The Fortune-Teller) by Machado de Assis, level B1, collections ['classics']. Premise: In Rio de Janeiro, a hidden love between two old friends' families is threatened by anonymous letters and a fortune-teller's reassuring words.
- es-quiroga-almohadon: "El almohadón de plumas" (The Feather Pillow) by Horacio Quiroga, level B2, collections ['classics']. Premise: A young bride grows steadily weaker in her cold husband's silent house, and no doctor can explain why.
- fr-flaubert-coeur-simple: "Un cœur simple" (A Simple Heart) by Gustave Flaubert, level C1, collections ['classics']. Premise: Félicité, an illiterate servant of unwavering devotion, spends fifty years serving one household in provincial Normandy, giving everything she has to love and losing, one by one, everyone and everything she loves.
